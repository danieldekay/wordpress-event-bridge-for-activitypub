<?php
/**
 * Test class file for the transformation of the events of the WordPress event plugin EventPrime.
 *
...
/**
 * Test class for the transformation of the events of the WordPress event plugin EventPrime.
 *
 * @coversDefaultClass \Event_Bridge_For_ActivityPub\ActivityPub\Transformer\Event\EventPrime
 */
class Test_EventPrime extends \WP_UnitTestCase {
	...
	public function test_the_events_calendar_transformer_class() {
		...
		$this->assertInstanceOf( \Event_Bridge_For_ActivityPub\Activitypub\Transformer\Event\EventPrime::class, $transformer );
	}
	...
	public function test_transformation_of_minimal_event() {
		// Create an EventPrime Event without location.
		$ep_functions = new \Eventprime_Basic_Functions();
