...
<html>
	...
	<body>
		<header>
			...
			<nav role="navigation" aria-label="Main" class="menu">
				<ul class="menu__list">
					<li onclick="openPreviewForApplication('mobilizon')" id="application-navigation_mobilizon" class="application-navigation is-active">
					...
					<li onclick="openPreviewForApplication('mastodon')"  id="application-navigation_mastodon" class="application-navigation">
					...
					<li onclick="openPreviewForApplication('gancio')" id="application-navigation_gancio" class="application-navigation">
						<img aria-labelledby="Gancio" src="<?php echo esc_url( plugins_url( 'assets/img/gancio.png', EVENT_BRIDGE_FOR_ACTIVITYPUB_PLUGIN_FILE ) ); ?>"><div style="display: none;">G</div>ancio
					</li>
				</ul>
			</nav>
		</header>
	...
	<script>
		function openPreviewForApplication(applicationName) {
			...
			var x = document.getElementsByClassName("application-navigation");
			for (i = 0; i < x.length; i++) {
				x[i].classList.remove( "is-active");
			}
			document.getElementById(applicationName).style.display = "block";
			document.getElementById("application-navigation_" + applicationName).classList.add("is-active");
		}
	</script>
</html>
